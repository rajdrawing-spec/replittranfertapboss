...
export const SYSTEM_ROLES: SystemRoleDef[] = [
  ...
  { key: "marketing_manager", name: "Marketing Manager", description: "Runs marketing campaigns and analytics.", permissions: ["dashboard.view", "marketing.view", "marketing.manage", "crm.view", "documents.view", "chat.read", "meetings.read"] },
  { key: "operations_manager", name: "Operations Manager", description: "Oversees orders, inventory and shipping.", permissions: ["dashboard.view", "orders.view", "orders.manage", "inventory.view", "inventory.manage", "shipping.view", "shipping.manage", "approvals.view", "chat.read", "meetings.read"] },
  { key: "sales_manager", name: "Sales Manager", description: "Manages customers and sales orders.", permissions: ["dashboard.view", "crm.view", "crm.manage", "orders.view", "marketing.view", "chat.read", "meetings.read"] },
  { key: "inventory_manager", name: "Inventory Manager", description: "Manages stock and products.", permissions: ["dashboard.view", "inventory.view", "inventory.manage", "orders.view", "chat.read", "meetings.read"] },
  { key: "shipping_manager", name: "Shipping Manager", description: "Manages shipments and returns.", permissions: ["dashboard.view", "shipping.view", "shipping.manage", "orders.view", "chat.read", "meetings.read"] },
  { key: "customer_support", name: "Customer Support", description: "Views customers and orders to help buyers.", permissions: ["dashboard.view", "crm.view", "orders.view", "chat.read", "callcenter.view", "meetings.read"] },
  { key: "finance", name: "Finance", description: "Access to finance and documents.", permissions: ["dashboard.view", "finance.view", "finance.manage", "treasury.view", "treasury.manage", "funds.view", "funds.manage", "documents.view", "shareholders.view", "chat.read", "meetings.read"] },
  { key: "director", name: "Director", description: "Company oversight: dashboard, finance, approvals and shareholder cap table.", permissions: ["dashboard.view", "finance.view", "treasury.view", "funds.view", "approvals.view", "approvals.manage", "shareholders.view", "documents.view", "chat.read", "chat.manage", "meetings.read", "meetings.manage", "director.view"] },
