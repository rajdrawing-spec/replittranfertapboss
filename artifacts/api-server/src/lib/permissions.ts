...
export const SYSTEM_ROLES: SystemRoleDef[] = [
  ...
  { key: "marketing_manager", name: "Marketing Manager", description: "Runs marketing campaigns and analytics.", permissions: ["dashboard.view", "marketing.view", "marketing.manage", "inventory.view", "inventory.manage", "ai.read", "crm.view", "documents.view", "chat.read", "chat.write", "meetings.read", "meetings.create"] },
