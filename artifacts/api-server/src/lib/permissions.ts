...
export const SYSTEM_ROLES: SystemRoleDef[] = [
  ...
  { key: "marketing_manager", name: "Marketing Manager", description: "Runs marketing campaigns and analytics.", permissions: ["dashboard.view", "marketing.view", "marketing.manage", "inventory.view", "inventory.manage", "ai.read", "crm.view", "finance.view", "documents.view", "chat.read", "chat.write", "meetings.read", "meetings.create"] },
  { key: "operations_manager", name: "Operations Manager", description: "Oversees orders, inventory and shipping.", permissions: ["dashboard.view", "orders.view", "orders.manage", "inventory.view", "inventory.manage", "shipping.view", "shipping.manage", "approvals.view", "finance.view", "chat.read", "chat.write", "meetings.read", "meetings.create"] },
  ...
  { key: "customer_support", name: "Customer Support", description: "Views customers and orders to help buyers.", permissions: ["dashboard.view", "crm.view", "orders.view", "finance.view", "chat.read", "chat.write", "callcenter.view", "meetings.read", "meetings.create"] },
  ...
  { key: "shareholder", name: "Shareholder", description: "Views their own equity, cap table and investment history.", permissions: ["dashboard.view", "shareholders.view", "finance.view", "meetings.read"] },
  {
    key: "staff",
    name: "Staff / Employee",
